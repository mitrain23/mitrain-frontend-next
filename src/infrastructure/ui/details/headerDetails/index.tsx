    ...
    <div className="flex flex-col md:flex-row gap-[28px] mb-[41px]">
      ...
      <div className="right">
        ...
        <div className="flex flex-row gap-[18px] mb-[22px]">
          ...
          <button className="rounded-[27px] text-black border-[1px] border-[#F2F2F2] font-inter text-[16px] py-[12px] px-[32px]">
            Contact Merchant
          </button>
        </div>
