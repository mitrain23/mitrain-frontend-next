...
const toggleAccordion = () => {
    ...
    return (
        <div className={`${expanded ? 'h-[396px]' : 'h-fit'} expandable-card w-full border-[1px] border-[#E7E7E7] p-[24px] mb-[8px]`} onClick={toggleAccordion}>
            ...
            {expanded && 
            <div dangerouslySetInnerHTML={{ __html: `KONDISI ISTIMEWAH MOBIL SECOND RASA BARU<br>
