      ...
      <form action="" className="flex flex-col gap-[16px]">
        ...
        <div className="flex flex-col gap-[16px]">
          <input
            ...
            className="input input-bordered w-full h-[56px] placeholder:text-[#757575]"
          />
          <Link href={"/results"}>
            <button className="bg-color5 w-full px-[82px] py-[16px] text-white rounded-[8px] font-medium">
              Search
            </button>
          </Link>
        </div>
