...
const BingungCariSupplier = () => {
  ...
  const advantagePoint = () => {
    return (
      <div className="advantage-point-container flex flex-row gap-[36px] mb-[12px]">
  ...
  return (
    <div className="flex flex-col md:flex-row md:gap-[52px] md:items-center ">
      ...
      <div>
        <h1 className="font-satoshi text-[48px] font-bold text-black mb-[32px]">
          Bingung Cari Supplier?
        </h1>
        <p className="font-inter text-[#425379] text-[16px] mb-[20px]">
          Dengan MitraIn ID, kebutuhan bisnis konveksi kamu dapat terpenuhi{" "}
          <br /> dengan terjamin kualitas dan dengan harga yang terjangkau.
        </p>
        {advantagePoint()}
        {advantagePoint()}
      </div>
