  ...
  return (
    <div className="w-[435px] h-[340px] rounded-[16px] bg-[#fafafa] py-[32px] px-[28px] flex flex-col items-center justify-center">
      ...
      <p className="text-center">
        Dengan MitraIn ID, kebutuhan bisnis konveksi kamu dapat terpenuhi dengan
        terjamin kualitas dan dengan harga yang terjangkau.
      </p>
    </div>
  );
};
