...
const MessageTopBar = () => {
    return (
        <div className='w-full h-[110px] flex flex-row justify-between items-center'>
            <div className='left flex items-center gap-[24px]'>
                <div>
                ...
                <div className='flex flex-col'>
                    <h1 className='text-[#020831] font-satoshi text-[24px] font-bold'>Indrawan Firgiawan Siregar</h1>
                    <p className='font-inter text-[#425379] text-[16px]'>Last online 7 hours ago</p>
                </div>
            </div>

            <div className='right'>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <mask id="mask0_304_462" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                        <rect width="24" height="24" fill="#D9D9D9" />
                    </mask>
                    <g mask="url(#mask0_304_462)">
