      ...
      <div className="right flex flex-row gap-[20px] max-md:self-end max-md:mt-4">
        ...
        <div className="cursor-pointer relative" onClick={handleShowDelete}>
          ...
          {showDelete && (
            <>
              <div
                className="bg-white w-[146px] px-[48px] py-[12px] flex items-center justify-center rounded-[7px] z-10 absolute top-[35px] right-0 shadow-md cursor-pointer"
                onClick={handleShowDeleteModal}
              >
                Delete
              </div>
