...
const Pagination = ({ handlePageChange }: any) => {
  ...
  return (
    <ReactPaginate
      ...
      containerClassName={
        "flex gap-2 mt-2 lg:mt-12 justify-center gap-[14px] items-center w-fit mx-auto text-[#6F7277] font-inter text-[18px]"
      }
      activeClassName={
        "bg-[#020831] w-[36px] h-[36px] rounded-full flex items-center justify-center text-white"
      }
      pageClassName={""}
      pageLinkClassName={
