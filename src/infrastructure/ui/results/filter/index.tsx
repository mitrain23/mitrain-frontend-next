...
const Filter = () => {
    ...
    return (
        <div className=''>
            ...
            >
                <div className='flex flex-col px-[16px] py-[16px] gap-[12px]' ref={focusRef}>
