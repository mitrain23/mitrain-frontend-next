...
const Page = () => {
    ...
    return (
        <LayoutTemplate>
            <>
                <h1 className='font-inter text-[30px] font-semibold mb-[32px] mt-[42px]'>Gabung Sebagai Mitra</h1>
                <form className='flex flex-col max-md:items-center md:gap-[42px]' onSubmit={handleSubmit}>
                    <label className="flex flex-col md:flex-row items-start justify-start md:justify-between gap-10 py-2 w-full">
                        <div className='flex flex-col items-start justify-center gap-2 lg:w-[550px]'>
                            <h2 className='text-black font-satoshi font-bold text-[22px]'>Nama Lengkap</h2>
                            <div className='font-inter text-[#425379] text-[16px] flex flex-col gap-[12px]'>
                                Pastikan nama Anda diawali dengan huruf kapital dan <br /> tidak menggunakan karakter khusus.
                            </div>
                    ...
                    <label className="flex flex-col md:flex-row items-start justify-start md:justify-between gap-10 py-2 w-full">
                        <div className='flex flex-col items-start justify-center gap-2 md:w-[550px]'>
                            <h2 className='text-black font-satoshi font-bold text-[22px]'>Email Aktif</h2>
                            <div className='font-inter text-[#425379] text-[16px] flex flex-col gap-[12px]'>
                    ...
                    <label className="flex flex-col md:flex-row items-start justify-start md:justify-between gap-10 py-2 w-full">
                        <div className='flex flex-col items-start justify-center gap-2 md:w-[550px]'>
                            <h2 className='text-black font-satoshi font-bold text-[22px]'>Buat Password</h2>
                            <div className='font-inter text-[#425379] text-[16px] flex flex-col gap-[12px]'>
                    ...
                    <label className="flex flex-col md:flex-row items-start justify-start md:justify-between gap-10 py-2 w-full">
                        <div className='flex flex-col items-start justify-center gap-2 md:w-[550px]'>
                            <h2 className='text-black font-satoshi font-bold text-[22px]'>Deskripsi</h2>
                            <div className='font-inter text-[#425379] text-[16px] flex flex-col gap-[12px]'>
                                Ceritakan pada kami tentang mengapa Anda <br /> memutuskan untuk bergabung sebagai Mitra.
                            </div>
                        </div>
                        <textarea
                    ...
                    <button className='btn mb-5' type="submit">Gabung</button>
                </form>
